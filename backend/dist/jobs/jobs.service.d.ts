...
export declare class JobsService {
    ...
    constructor(jobsRepo: Repository<JobEntity>, bidsRepo: Repository<BidEntity>, orderBook: OrderBookService, escrow: EscrowService, walletService: WalletService, websocketGateway: WebsocketGateway);
